...
namespace Sesia_Przestepne.Context
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Year,Leap,SearchTime")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Year,Leap,SearchTime")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
